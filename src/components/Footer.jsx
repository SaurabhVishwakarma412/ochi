...
const Footer = () => {
  return (
    <footer className="w-full flex flex-col md:flex-col lg:flex-row min-h-screen bg-zinc-900 p-20 text-white">
      
      {/* Left Section */}
      <div className="w-1/2 space-y-20 md:w-full flex flex-col justify-between mb-10 lg:mb-0">
        <div className="leading-none">
          <h1 className="text-[10vh] font-semibold uppercase">Eye-</h1>
          <h1 className="text-[10vh] font-semibold uppercase">Opening</h1>
        </div>
      ...
      <div className="w-1/2 md:w-full">
        <h1 className="text-[10vh] font-semibold uppercase">Presentation</h1>

        <div className="flex flex-wrap justify-between py-20 gap-10 text-sm text-gray-300">
          {/* Social Links */}
          ...
          {/* Addresses */}
          <div className="flex flex-col space-y-2">
            <a href="#" className="hover:text-white transition">202-1965 W 4th Ave</a>
            <a href="#" className="hover:text-white transition">Vancouver, Canada</a>
            <a href="#" className="hover:text-white transition">30 Chukarina St</a>
            <a href="#" className="hover:text-white transition">Lviv, Ukraine</a>
          </div>

          {/* Email */}
          <div className="flex flex-col justify-end">
            <a href="mailto:hello@ochi.design" className="hover:text-white transition">
              hello@ochi.design
            </a>
          </div>
        </div>
        ...
        {/* Footer Bottom */}
        <div className="text-zinc-400 flex justify-between text-xs md:flex-col md:items-start md:space-y-2">
          <p>&copy; ochi design 2025. <a href="#" className="underline hover:text-white">Legal Terms</a></p>
          <p>Website by <span className="text-white font-medium">Saurabh</span></p>
        </div>
      </div>
    </footer>
  )
